...
1.  Amber uses the following information to populate the fields on the new Goal:
    -  **Name**: Reduce Scope 2 Emissions – 2022
    -  **Owner**: Your IAD User
...
1.  Enter the data mentioned above:
    1. **Name** is used for identifying the goal in the list.
    1. **Owner** is used to identify the primary person responsible for monitoring and tracking goal progress
    1. **Scorecard** is used to specify which scorecard to associate the goal with. In this scenario, because the goal was created on the scorecard page, the scorecard field is automatically filled out.
    1. **Organizational unit** is used to identify which Organizational unit the goal is associated with
    1. **Start date** is used to identify the starting time frame of the goal
